...
TrueLifecycleEvent _$TrueLifecycleEventFromJson(Map<String, dynamic> json) {
...
class _$TrueLifecycleEventTearOff {
  const _$TrueLifecycleEventTearOff();
...
const $TrueLifecycleEvent = _$TrueLifecycleEventTearOff();
...
class _$_Resume with DiagnosticableTreeMixin implements _Resume {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TrueLifecycleEvent.resume()';
  }

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'TrueLifecycleEvent.resume'));
  }
...
abstract class _Resume implements TrueLifecycleEvent {
...
class _$_Suspend with DiagnosticableTreeMixin implements _Suspend {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TrueLifecycleEvent.suspend()';
  }

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'TrueLifecycleEvent.suspend'));
  }
...
abstract class _Suspend implements TrueLifecycleEvent {
  const factory _Suspend() = _$_Suspend;

  factory _Suspend.fromJson(Map<String, dynamic> json) = _$_Suspend.fromJson;
}

TrueLifecycleState _$TrueLifecycleStateFromJson(Map<String, dynamic> json) {
  switch (json['runtimeType'] as String) {
    case 'just':
...
mixin _$TrueLifecycleState {
  @optionalTypeArgs
  Result when<Result extends Object>({
    @required
        Result just(@required List<TrueLifecycleEvent> log,
...
class _$TrueLifecycleStateTearOff {
  const _$TrueLifecycleStateTearOff();
...
const $TrueLifecycleState = _$TrueLifecycleStateTearOff();
...
class _$_Just with DiagnosticableTreeMixin implements _Just {
  ...
  @override
  final List<TrueLifecycleEvent> log;
  @override
  final TrueLifecycleEvent current;

  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TrueLifecycleState.just(log: $log, current: $current)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'TrueLifecycleState.just'))
  ...
  _$_Just copyWith({
    ...
    return _$_Just(
      log: log == freezed ? this.log : log as List<TrueLifecycleEvent>,
      current:
          current == freezed ? this.current : current as TrueLifecycleEvent,
    );
  }
...
abstract class _Just implements TrueLifecycleState {
  const factory _Just(
      {@required List<TrueLifecycleEvent> log,
      @required TrueLifecycleEvent current}) = _$_Just;

  factory _Just.fromJson(Map<String, dynamic> json) = _$_Just.fromJson;

  List<TrueLifecycleEvent> get log;
  TrueLifecycleEvent get current;

  _Just copyWith({List<TrueLifecycleEvent> log, TrueLifecycleEvent current});
}
...
class _$_Nothing with DiagnosticableTreeMixin implements _Nothing {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TrueLifecycleState.nothing()';
  }

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties..add(DiagnosticsProperty('type', 'TrueLifecycleState.nothing'));
  }
...
abstract class _Nothing implements TrueLifecycleState {
